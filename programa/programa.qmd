...
## `r advdate(inicio_semestre, 16)`: Reportes Automatizados I: Introducción a R Markdown

-   Sintaxis básica de Markdown
-   Chunks de R en R Markdown
-   Generación de reportes en diferentes formatos (PDF, HTML)

## `r advdate(inicio_semestre, 17)`: Reportes Automatizados II: R Markdown Avanzado
...
1.  Tarea de programación I (35%)
    ...
    -   Contenidos: Importación y exportación, agrupación y resumen de datos y manipulación de datos de datos con dplyr,  Manipulación de datos II (unión), manejo de datos faltantes. 
    
2.  Tarea de programación II (35%)
    -   Instrumento: Rúbrica y Diagrama de flujo (Pauta de cotejo)
    -   Contenidos: Transformación de datos (tidyr), iteración y automatización (purrr), creación de gráficas (ggplot). 
